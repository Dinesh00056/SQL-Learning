...
-- correlated subquery is a type of subquery that is depend and executed on outer query

select *  from employees;
select *  from departments;

select salary from employees where empname='Bob';
select * from employees where salary>(select salary from employees where epname='Bob');

-- Q1) get the name of the employees who has a salary greater than the avg salary of the department
