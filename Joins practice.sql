...
order by Totalenrollments desc, c.coursename;

--

-- Show course name and student name together using a join.
select c.coursename ,studentname  from courses as c
join enrollment as e on c.courseid=e.courseid
join student

-- Show all students and the courses they enrolled in (even if some didn’t enroll). 
...
select s.studentname,sum(c.credits) from courses as c
...
inner join enrollments as e on e.courseid=course